 ...
 *
 * <p>Note: this reports the Gateway's own DB only. Account Service health is
 * deliberately not folded in here — the Gateway must stay available for local
 * reads even when Account is down (graceful degradation, requirement 6).
 */
@RestController
